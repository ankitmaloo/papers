...
function Fig6_CoTvsLoop() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, playing ? "Pause" : "Auto-play"), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    onClick: () => {
  ...
  }, "Worked example \xB7 both models see the same question"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, s.title.split("·")[1]?.trim())), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 0,
      display: "grid",
    ...
    sub: "GPT-style \xB7 thinks in tokens",
    color: "var(--teal)"
  }, /*#__PURE__*/React.createElement(CoTPane, {
    step: s.k,
    subT: subT
  })), /*#__PURE__*/React.createElement(Pane, {
    label: "Looped Transformer",
    sub: "Huginn / Ouro \xB7 thinks in latent space",
    color: "var(--accent)"
  }, /*#__PURE__*/React.createElement(LoopPane, {
    step: s.k,
    subT: subT
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
...
function CoTPane({
  ...
  let tokens = [];
  let emitted = 0;
  if (step === "prompt") tokens = PROMPT_TOKENS.map(t => ({
    t,
    k: "prompt"
  }));else if (step === "embed") tokens = PROMPT_TOKENS.map(t => ({
    t,
    k: "prompt"
  }));else if (step === "diverge") tokens = PROMPT_TOKENS.map(t => ({
    t,
    k: "prompt"
  }));else if (step === "cot-think") {
    emitted = Math.floor(subT * COT_REASONING.length);
    tokens = [...PROMPT_TOKENS.map(t => ({
      t,
      k: "prompt"
    })), ...COT_REASONING.slice(0, emitted).map(t => ({
      t,
      k: "gen"
    }))];
  ...
  if (step === "ledger") return /*#__PURE__*/React.createElement(CoTLedger, null);
  return /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
  ...
  }, tokens.map((tk, i) => /*#__PURE__*/React.createElement(Tok, {
    key: i,
    t: tk.t,
    kind: tk.k
  })), step === "cot-think" && /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-block",
      width: 6,
      height: 16,
  ...
  })), /*#__PURE__*/React.createElement(CoTBottleneck, {
    step: step,
    subT: subT
  }));
}
function CoTBottleneck({
  step,
  subT
}) {
  ...
  }, "per-step data flow:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 4
  ...
  }, "vocab \xB7 50k"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--ink-faint)"
    }
  }, "\u2192"), /*#__PURE__*/React.createElement("span", {
  ...
  }, "1 token (~16 bits)"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--ink-faint)"
    }
  }, "\u2192"), /*#__PURE__*/React.createElement("span", {
  ...
  }, "re-embed")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 4,
      color: show ? "var(--accent)" : "var(--ink-faint)"
    }
...
function CoTLedger() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    k: "reasoning tokens",
    v: "15",
    note: "verbalized intermediate steps"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "bandwidth / step",
    v: "~16 bits",
    note: "vocab bottleneck"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "FLOPs / step",
    v: "1\xD7 full forward",
    note: "entire net per token"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "total cost",
    v: "15\xD7 forward",
    note: "one per reasoning token"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "trace visible",
    v: "yes \u2014 readable",
    note: "but can be post-hoc",
    dim: true
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "faithfulness",
    v: "often unfaithful",
    note: "justifies, doesn't reason",
    warn: true
  }));
}
function LedgerRow({
...
function LoopPane({
  ...
  if (step === "ledger") return /*#__PURE__*/React.createElement(LoopLedger, null);

  // Show the prompt tokens always; highlight residual evolution
  const tokens = PROMPT_TOKENS.map(t => ({
    t,
    k: "prompt"
  }));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    t: tk.t,
    kind: tk.k
  })), showEmit && /*#__PURE__*/React.createElement(Tok, {
    t: ANSWER,
    kind: "ans"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "residual stream \xB7 4096d (showing 32) \xB7 loop pass ", loopActive ? loopIdx + 1 : "–", "/8"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  })), loopActive && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 4,
      marginTop: 8,
  ...
  }, step === "settle" ? "converging to fixed point" : "reapplying shared block")), step === "emit" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      padding: "6px 8px",
      background: "var(--paper)",
  ...
  }, "final unembed \u2192 "), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "var(--mono)",
      fontWeight: 500,
      color: "var(--accent)"
  ...
  }, "one token, 8\xD7 compute behind it"))), /*#__PURE__*/React.createElement("div", {
    style: {
      border: "1px dashed var(--rule-strong)",
      borderRadius: 4,
      padding: "6px 8px",
  ...
  }, "per-loop data flow:", /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 4,
  ...
  }, "residual ~4096d"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--ink-faint)"
    }
  }, "\u2192"), /*#__PURE__*/React.createElement("span", {
  ...
  }, "SAME block"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--ink-faint)"
    }
  }, "\u2192"), /*#__PURE__*/React.createElement("span", {
  ...
  }, "residual ~4096d")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 4,
      color: "var(--accent)"
    }
...
function LoopLedger() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    k: "loops",
    v: "8",
    note: "shared block reapplied"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "bandwidth / loop",
    v: "~65,000 bits",
    note: "full residual carried"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "FLOPs / loop",
    v: "1\xD7 recurrent block",
    note: "smaller than full net"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "total cost",
    v: "8\xD7 block \u2248 2\xD7 forward",
    note: "fewer FLOPs, more thought"
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "trace visible",
    v: "via logit lens / probes",
    note: "readable IF you probe",
    dim: true
  }), /*#__PURE__*/React.createElement(LedgerRow, {
    k: "faithfulness",
    v: "structural",
    note: "the trace IS the reason",
    warn: true
  }));
}
